...
- 내 위치 기준 가까운 정류장 (목록 + 지도)
- 정류장별 도착 예정 버스, **방면 표시**, 저상버스 여부
- 정류장을 지나는 전체 노선 (막차 후에도 확인 가능)
- 길찾기 — 환승 없이 갈 수 있는 버스를 도착 순으로
- 즐겨찾기, 최근 본 정류장, 초성·번호 검색
